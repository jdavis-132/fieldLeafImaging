...
p <- ggplot() +
  ...
  # Set fill colors
  scale_fill_manual(values = c("yes" = paletteer_d("ggsci::default_gsea", 4)[4], "no" = "white"),
                    guide = "none") +
...
# Save the plot
ggsave("figures/main/figure1/us_study_sites_map.svg", p, width = 3.2*2, height = 2.6*2, dpi = 1000, bg = NULL)
