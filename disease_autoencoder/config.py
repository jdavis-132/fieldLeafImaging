...
class DiseaseConfig:
    ...
    def __init__(self):
        ...
        self.models_dir = self.base_dir / 'disease_autoencoder' / 'models'
        self.embeddings_dir = self.base_dir / 'disease_autoencoder' / 'embeddings'
        self.visualizations_dir = self.base_dir / 'disease_autoencoder' / 'visualizations'
        self.logs_dir = self.base_dir / 'disease_autoencoder' / 'logs'
