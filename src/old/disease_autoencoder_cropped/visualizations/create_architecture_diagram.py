...
png_path = output_dir / 'architecture_diagram.png'
svg_path = output_dir / 'architecture_diagram.svg'
...
print(f"✓ Created {png_path} (PNG, 150 DPI)")
print(f"✓ Created {svg_path} (SVG, vector format)")
print("\nDiagram features:")
