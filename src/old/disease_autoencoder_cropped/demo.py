...
Usage:
    ...
    python -m disease_autoencoder_cropped.demo

    # Test on specific number of samples
    python -m disease_autoencoder_cropped.demo --num_samples 10

    # Generate detailed report
    python -m disease_autoencoder_cropped.demo --report

    # Compare specific genotypes
    python -m disease_autoencoder_cropped.demo --compare --genotype "PI123456"
"""
...
from src.disease_autoencoder_cropped.loss import DiseaseWeightedLoss
...
def load_model(config):
    ...
    if not checkpoint_path.exists():
        ...
        print("Please train the model first: python -m disease_autoencoder_cropped.train")
        return None
