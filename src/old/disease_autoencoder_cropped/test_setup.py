...
def test_imports():
    ...
    try:
        ...
        from src.disease_autoencoder_cropped.model import DiseaseAutoencoder, create_model
...
def test_model_creation():
    ...
    try:
        from src.disease_autoencoder_cropped.config import DiseaseConfig
        from src.disease_autoencoder_cropped.model import test_model_shapes
...
def main():
    ...
    if all_passed:
        ...
        print("\nNext steps:")
        print("  1. Train: python -m disease_autoencoder_cropped.train")
        print("  2. Evaluate: python -m disease_autoencoder_cropped.evaluate")
    else:
