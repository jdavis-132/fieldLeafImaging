...
class DiseaseConfig:
    ...
    def __init__(self):
        ...
        # Output directories for disease autoencoder
        self.models_dir = self.base_dir / 'src' / 'disease_autoencoder' / 'models'
        self.embeddings_dir = self.base_dir / 'src' / 'disease_autoencoder' / 'embeddings'
        self.visualizations_dir = self.base_dir / 'src' / 'disease_autoencoder' / 'visualizations'
        self.logs_dir = self.base_dir / 'src' / 'disease_autoencoder' / 'logs'
    ...
    def __repr__(self):
        ...
        config_str = "Disease-Aware Autoencoder Configuration:\n"
