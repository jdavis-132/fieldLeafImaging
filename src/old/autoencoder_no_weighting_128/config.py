...
class AutoencoderConfig:
    ...
    def __init__(self):
        ...
        self.models_dir = self.base_dir / 'src' / 'autoencoder_no_weighting_128' / 'models'
        self.embeddings_dir = self.base_dir / 'src' / 'autoencoder_no_weighting_128' / 'embeddings'
        self.visualizations_dir = self.base_dir / 'src' / 'autoencoder_no_weighting_128' / 'visualizations'
        self.logs_dir = self.base_dir / 'src' / 'autoencoder_no_weighting_128' / 'logs'
        ...
        # Model architecture
        self.embedding_dim = 128  # Bottleneck dimension
