"""
Evaluation and visualization script for standard autoencoder (no disease weighting).
...
from src.autoencoder_no_weighting_128.model import DiseaseAutoencoder
from src.autoencoder_no_weighting_128.dataset import DiseaseLeafDataset
...
def main():
    ...
    print("="*60)
    print("Standard Autoencoder Evaluation (No Disease Weighting)")
    print("="*60)
