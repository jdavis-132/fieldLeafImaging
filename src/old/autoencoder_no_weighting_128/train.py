"""
Training script for standard autoencoder (no disease weighting).

Modified from disease-aware version to use simple MSE loss instead of
disease-weighted loss. All other training procedures remain the same.
"""
...
from src.autoencoder_no_weighting_128.dataset import get_dataloaders
from src.autoencoder_no_weighting_128.model import create_model
from src.autoencoder_no_weighting_128.loss import create_loss_function


class Trainer:
    """Training manager for standard autoencoder."""
    ...
    def train_epoch(self, model, dataloader, optimizer, loss_fn, lab_stats):
        ...
        epoch_stats = {
            ...
            'mean_weight': 1.0  # No weighting in this version
        }
    ...
    def save_checkpoint(self, model, optimizer, scheduler, is_best=False):
        ...
        checkpoint = {
            ...
            'config': {
                ...
                'loss_type': 'simple_mse'  # Indicate no disease weighting
            }
        }
    ...
    def train(self, model, dataloaders, lab_stats):
        ...
        print(f"\n{'='*60}")
        print("Starting Training (No Disease Weighting)")
        print(f"{'='*60}")
        ...
        print(f"Loss type: Simple MSE (no disease weighting)")
        print(f"{'='*60}\n")
...
def main():
    ...
    # Save splits to autoencoder logs
