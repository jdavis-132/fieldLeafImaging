...
# manual phenos
Rscript src/R/LV_quantGen.R -manual -data/manual/scores_813.csv -data/ne2025/SbDiv_ne2025_fieldindex.csv -score_average -scores_813 -0.01 -data/ne2025/genotype_alignment_reseq.csv > logs/scores_813_quantgen.Rout 2>&1
Rscript src/R/LV_quantGen.R -manual -data/manual/scores_828.csv -data/ne2025/SbDiv_ne2025_fieldindex.csv -score_average -scores_828 -0.01 -data/ne2025/genotype_alignment_reseq.csv > logs/scores_828_quantgen.Rout 2>&1
