...
Rscript src/R/LV_quantGen.R -image -models/autoencoder_20260108_012555_standard_lr0.001_bs32_l1_attention/embeddings.csv -data/ne2025/SbDiv_ne2025_fieldindex.csv -latent_dim -ae4 -0.01 -data/SbDiv_Mangal2025_genotypes.txt > logs/ae4_quantgen.Rout 2>&1
