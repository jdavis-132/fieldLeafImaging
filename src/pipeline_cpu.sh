...
Rscript src/R/LV_quantGen.R -image -output/sam3_embeddings.csv -data/ne2025/SbDiv_ne2025_fieldindex.csv -embedding -sam3_rs -0.01 -data/ne2025/genotype_alignment_reseq.csv -data/ne2025/images_senesced_removed.csv > logs/sam3_rs_quantgen.Rout 2>&1
