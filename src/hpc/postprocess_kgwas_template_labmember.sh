...
#SBATCH --mem=16G
#SBATCH --time=2:00:00
#SBATCH --output=/work/schnablelab/jdavis132/fieldLeafImaging/log/kgwas_postproc_%a.out
#SBATCH --error=/work/schnablelab/jdavis132/fieldLeafImaging/log/kgwas_postproc_%a.err
...
BASE="/work/schnablelab/jdavis132/fieldLeafImaging/out/gwas/kgwas/embeddings/${TRAIT_NAME}_1M"
...
BEST_PVALS="${BASE}/kmers/best_pvals"
